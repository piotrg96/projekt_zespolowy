...
class MyAdsUpdate extends React.Component {
    ...
    handleSubmit(event) {
        ...
        dispatch(userActions.advUpdate(update, update.id));
    }
    ...
    const { id, users, title , category, price, description, yardage, city, province, phone } = this.props.location.state;
...
function mapStateToProps(state) {
    const { users, authentication, myAds } = state;
...
const connectedMyAdsUpdate = connect(mapStateToProps)(MyAdsUpdate);
export { connectedMyAdsUpdate as MyAdsUpdate };